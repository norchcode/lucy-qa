...
import { buildQaPlanPrompt } from '../../../packages/qa-core/src/index.mjs';
import { buildQaClarificationResult, buildQaIntakeContext } from './qa-intake.mjs';

export const runQaPlanCommand = async ({ goal, targetUrl = null, providerName = null, model = null, taskType = 'qa' }) => {
  ...
  const prompt = buildQaPlanPrompt(goal, { analysis: intake, docsContext });
